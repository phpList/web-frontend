      ...
      <div class="relative bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg md:min-w-xl sm:w-full z-10">
        <div class="bg-white dark:bg-slate-800 px-4 pt-5 pb-4 sm:p-6">
          <div class="flex justify-between items-center">
            <h3 id="create-list-modal-title" class="text-lg leading-6 font-medium text-slate-900 dark:text-slate-100">
              Create New List
            </h3>
            ...
            <div>
              <label for="list-position" class="block text-sm font-medium text-slate-700 dark:text-slate-200">List Position (optional)</label>
              <input
                id="list-position"
            ...
            <div>
              <label for="list-description" class="block text-sm font-medium text-slate-700 dark:text-slate-200">Description (optional)</label>
              <textarea
                id="list-description"
