...
vi.mock('./BounceOverview.vue', () => ({ default: { template: '<div data-testid="bounce-overview" />' } }))
vi.mock('./BounceRules.vue',    () => ({ default: { template: '<div data-testid="bounce-rules" />' } }))
vi.mock('./BouncePer.vue',      () => ({ default: { template: '<div data-testid="bounce-per" />' } }))
