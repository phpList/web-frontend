<template>
  ...
  >
    ...
    <div
        class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full z-10"
    >
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
        ...
        <form class="mt-4 space-y-4" @submit.prevent="submitEditList">
          ...
          <div>
            <label for="list-rssFeed" class="block text-sm font-medium text-slate-700">RssFeed url</label>
            <input
                id="list-rss"
          ...
          <div>
            <label for="list-subjectPrefix" class="block text-sm font-medium text-slate-700">Subject Prefix</label>
            <input
                id="list-prefix"
...
const fillEditForm = () => {
  editForm.value = {
    ...
    listPosition:
        props.list?.listPosition !== null && props.list?.list_position !== undefined
            ? String(props.list.list_position)
            : null,
